...
?>
			-->
				...
				<?
					if($table_id == 'table_1657186161' || $table_id == 'table_1657186170'){
				?>				
				<div class="tbl-st-row clearfix"> 
					<div class="tbl-st-col col-1">간단설명</div>	
					<div class="tbl-st-col col-2">
						<input name="data01" type="text" style='width:99%;' value="<?=$data01?>">
					</div>
				</div>
	...
	<div class="tbl-st-row clearfix">
		...
		<div class="tbl-st-col col-2">
			<div class="file_input">
				...
				<?
					if($table_id=='table_1657175018'){//카테고리
				?>
					<span class="f14 dp_ib m-12">권장사이즈 1:1 (ex. 600*600 px)</span>
				<?
					}elseif($table_id=='table_1657184969'){//포트폴리오
				?>
					<span class="f14 dp_ib m-12">권장사이즈 16:9 (ex. 640*360 px)</span>
				<?
					}
				?>
					<span class="f14 dp_ib m-12">권장사이즈 16:9 (ex. 640*360 px)</span>
...
?>
<?
	$mentNone2='display:none;';
	if($table_id=='table_1657175018' || $table_id=='table_1657184969' || $table_id=='table_1657599360'){
		$mentNone='display:none;';
	}else{
		$mentNone='display:block;;';
	}
	if($table_id=='table_1657184969' || $table_id=='table_1657599360'){
		$mentNone2='display:table;';
	}else{
		$mentNone2='display:none;';
	}
...
?>
	<div>
		<div style='padding:5px 0px;<?=$mentNone?>'><textarea name="ment" id="ment" style='width:100%;height:400px;'><?=$ment?></textarea></div>
	</div>

	<div class="tbl-st-row clearfix" style='<?=$mentNone2?>'> 
		<div class="tbl-st-col col-1">유튜브영상</div>
		<div class="tbl-st-col col-2"><input name="data05" type="text" id='data05' style='width:99%;' value="<?=$data05?>"></div>
	</div>
