<script>
		...
		$('#fullpage2').fullpage({
		  ...
		  onLeave: function(anchorLink2, index2){//removeClass
			 ...
			 if(index2!=3){
				...
				$(".firstShow").show();
				$(".koreanTxt").hide();
				$(".sec03 .lastLine2").css('height','0').css('opacity','1');
				$(".sec03 .lastLine").css('height','0');
	...
	function index2Effect	(){
		$('.bigTxt').css({'position':'relative'}).css({'transform':'scale(1)'});
		$('.bigTxt').stop().animate({'top':0},1000,function(){
