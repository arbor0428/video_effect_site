				...
				<div class="graphWrap">
					...
					<div class="graphLine">
						<svg xmlns="http://www.w3.org/2000/svg" width="1330" height="430" viewBox="0 0 1330 430">
							...
							<path id="path2" data-name="path2" d="M5117.43,13214.679l297.844-36.383h0l150.395-50.687,148.909-86.094,303.845-86.109,220.745-95.926h0l197.046-64.039h0" transform="translate(-5111,-12789)" fill="none" stroke="rgba(255,255,255,0.2)" stroke-linecap="round" stroke-width="10"/>
						</svg>
						<!-- <div id='numTest'></div> -->
