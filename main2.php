...
<script src="https://mp.cafe24.com/js/lib/gsap.min.js" type="text/javascript"></script>
<script src="https://mp.cafe24.com/js/lib/MotionPathPlugin.min.js" type="text/javascript"></script>
<div id="fullpage2">
		...
		<div class="c_center">
			<div class="sec03Wrap">
				<div id="unique-id" class="upsideChn">
					<div class="firstShow">
						<span class="numBox poppin number" data-count="1000000000">0</span>
						명
					</div>
