			...
			<div class="sec03Wrap">
				...
				<div class="graphWrap">
					...
					<div class="graphLine">
						...
						<path id="path2" data-name="path2" d="M5117.43,13214.679l297.844-36.383h0l150.395-50.687,148.909-86.094,303.845-86.109,220.745-95.926h0l197.046-64.039h0" transform="translate(-5111,-12789)" fill="none" stroke="rgba(111,141,233,1)" stroke-linecap="round" stroke-width="7"/>
							<path id="path" data-name="path" stroke-dasharray="0,1395" style="stroke-dasharray: 0,1395;"d="M5117.43,13214.679l297.844-36.383h0l150.395-50.687,148.909-86.094,303.845-86.109,220.745-95.926h0l197.046-64.039h0" transform="translate(-5111,-12789)" fill="none" stroke="#fff" stroke-linecap="round" stroke-width="7"/>
		...
		<div class="c_center sec04Box">
			...
			<div class="sec04Bot">
				...
				<div class="iconWrap iconW02">
					<div class="iconBox">
						<div class="iconImg">
							<svg id="growthIcon" xmlns="http://www.w3.org/2000/svg" width="100" height="71.429" viewBox="0 0 100 71.429">
				...
				<div class="iconWrap iconW04">
					<div class="iconBox">
						<div class="iconImg">
							<svg id="posiIcon" xmlns="http://www.w3.org/2000/svg" width="100" height="92" viewBox="0 0 100 92">
				...
				<div class="iconWrap iconW05">
					<div class="iconBox">
						<div class="iconImg">
							<svg id="loveIcon"  xmlns="http://www.w3.org/2000/svg" width="100" height="87.996" viewBox="0 0 100 87.996">
