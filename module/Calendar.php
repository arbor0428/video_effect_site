...
.ui-datepicker{font-size:12px;width:240px;font-size:16px;}
.ui-datepicker select.ui-datepicker-month{width:37%;height:24px;font-size:16px;}
.ui-datepicker select.ui-datepicker-year{width:40%;height:24px;font-size:16px;}

.ui-datepicker td span, .ui-datepicker td a{font-size:16px;}
